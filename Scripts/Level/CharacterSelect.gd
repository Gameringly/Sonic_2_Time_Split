...
var levelLabels = ["Base Zone Act 1", "SurfTest", "Ridicule Root Zone Act 1"]#, "Chunk Zone Act 1"]
	...
	if !selected:
		...
		if event.is_action_pressed("gm_pause"):
			...
			match(levelID):
				...
				1: # SurfTest
					Global.nextZone = load("res://Scene/Zones/SurfTest.tscn")
				2: # Ridicule Root Act 1
					Global.nextZone = load("res://Scene/Zones/RidiculeRootAct1.tscn")
